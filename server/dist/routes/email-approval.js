...
const email_router_1 = require("../utils/email-router");
...
router.post('/confirm', async (req, res) => {
    try {
        const { logId, approved, overrideRecipients, finalBody } = req.body;
        if (!logId) {
 ...
 */
async function handleEmailApproval(draftLog, overrideRecipients, finalBody) {
    try {
        ...
        if (overrideRecipients && overrideRecipients.length > 0) {
            ...
            recipients = (0, email_router_1.getReportRecipients)('general');
        }
 ...
 */
async function handleEmailRejection(draftLog, finalBody) {
    try {
...
//# sourceMappingURL=email-approval.js.map