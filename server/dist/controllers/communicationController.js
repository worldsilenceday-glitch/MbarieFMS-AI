...
exports.getCommunicationStats = exports.getCommunicationLogById = exports.getCommunicationLogs = void 0;
...
const getCommunicationLogs = async (req, res) => {
    try {
        const { userId, type, startDate, endDate, page = '1', limit = '50' } = req.query;
        // Build where clause
        const where = {};
        if (userId) {
            where.userId = userId;
...
exports.getCommunicationLogById = getCommunicationLogById;
/**
