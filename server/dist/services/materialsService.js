...
class MaterialsService {
    ...
    static async getInventorySummary() {
        try {
            ...
            const lowStockItems = materials.filter(material => material.minLevel && material.qty <= material.minLevel).length;
     ...
     */
    static async updateMaterialQuantity(materialId, newQty) {
        try {
     ...
     */
    static async processTransfer(transferId, status) {
        try {
     ...
     */
    static async getMaterialTransferHistory(materialId) {
        try {
     ...
     */
    static async createPicklistTransfers(items, requestedById, destination) {
        try {
            const transfers = [];
     ...
     */
    static async getMaterialsByLocation(location) {
        try {
            const materials = await prisma.material.findMany({
                where: { location },
                orderBy: {
